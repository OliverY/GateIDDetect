 ...
 * Description:
 */
public class FaceAdapter extends BaseQuickAdapter<FaceDB.FaceRegist,BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, FaceDB.FaceRegist faceRegist) {
