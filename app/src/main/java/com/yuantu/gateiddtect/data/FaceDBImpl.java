...
@Singleton
public class FaceDBImpl implements FaceDB{
    ...
    @Inject
    public FaceDBImpl(@ApplicationContext Context context, DBHelper dbHelper, FileHelper fileHelper) {
...
//        Logger.e("query::"+dbHelper.queryById(faceModel.getId()).toString());
    ...
    public List<FaceModel> getAllFaceModel(){
        return mRegister;
    }
